...
public class UserHandler implements IUserHandler {
    ...
    private SimpleLogger logger = new SimpleLogger(Cognitio.class);
    ...
    public ITUser getUserByID(String id) {
        ...
        try {
            ...
            logger.high("[[IF THIS IS A BUG. CONTACT THE DEV.]]Could not grab user by ID! Message: " + ex.getMessage());
            return null;
        }
    }
}
